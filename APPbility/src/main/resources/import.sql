...
INSERT INTO user_entity (id, username, password, email, nombre, apellidos, fecha_nacimiento, sexo, modalidad_preferida, num_telefono, mostrar_num_telefono, color, imagen_perfil, idioma_nativo, descripcion_profesional, presentacion_personal, enabled, activation_token, created_at, pais_nativo_id, pais_residencia_id) VALUES ('f13a2e98-70f5-4d61-93ab-349be7022025', 'Elirart', '{noop}elira123', 'elira.qose@example.com', 'Elira', 'Qose', '1995-08-17', 'MUJER', 'VIRTUAL', '+355681234567', true, '#FF00CC', 'https://medias.artmajeur.com/mini/17840476_1.jpg', 'sq', 'Profesora de arte con enfoque en pintura abstracta. Más de 7 años de experiencia en talleres comunitarios y proyectos escolares.', 'Me encanta ayudar a otros a descubrir su lado artístico y expresarse a través de los colores.', true, NULL, CURRENT_TIMESTAMP, 5, 4);
